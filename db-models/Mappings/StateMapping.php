...
use DbModels\Repositories\StateRepository;
...
class StateMapping
{
    ...
    public function __invoke(ClassMetadata $metadata)
    {
        ...
        $builder->setTable('s10_states');
        $builder->setCustomRepositoryClass(StateRepository::class);
        ...
        $builder->addUniqueConstraint(['code'], 'states_uidx_code');
    }
}