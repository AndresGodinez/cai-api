...
/**
 * Class InventoryEvidenceCreateApiViewBadAuthorizationTest
 * @package Tests\App\Api\Views\InventoryEvidence
 */
class InventoryEvidenceCreateApiViewBadAuthorizationTest extends DbUnitTestCase
{
    ...
    public function testErrorNoAuthorizationHeader()
    {
        ...
        $request = TestUtils::makeServerRequestMock('POST', '/api/inventory-evidence');
